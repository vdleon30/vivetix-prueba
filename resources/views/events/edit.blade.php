                    ...
                    <div class="form-row row">
                        ...
                        <div class="form-group mb-3 col-12 col-lg-6">
                            ...
                            <x-text-input id="quantity" name="quantity" type="number" class="mt-1 block w-full"
                                required value="{{ $event->quantity }}" min=1 />
                        ...
                        <div class="form-group mb-3 col-12 col-lg-6">
                            ...
                            <x-text-input-text id="description" name="description" type="text"
                                class="mt-1 block w-full" required :text="$event->description" />
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>
                    </div>
                    <div class="d-flex justify-content-end my-4">
                        <button class="btn btn-primary mx-2">Actualizar</button>
                        <a href="{{ route('events.index') }}"  class="btn btn-danger  mx-2">Cancelar</a>
                    </div>
